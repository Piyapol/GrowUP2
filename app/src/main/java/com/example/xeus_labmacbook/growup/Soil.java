...
//        mCursorLoader = getLoaderManager().initLoader(0, null, this);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        final View view = inflater.inflate(R.layout.soil, container, false);
        return view;
...
//
//        mAddAlarmButton = (ImageButton) view.findViewById(R.id.alarm_add_alarm);
...
//        }
//
//        mEmptyView = view.findViewById(R.id.clock_empty_view);
...
//            }
//        });
//        mAlarmsList = (ListView) view.findViewById(R.id.clock_list);
//
...
//        final android.app.Fragment prev = getFragmentManager().findFragmentByTag("label_dialog");
//        if (prev != null) {
//            ft.remove(prev);
//        }
...
//
//    @Override
//    public void onLoadFinished(android.content.Loader<Cursor> cursorLoader, final Cursor data) {
